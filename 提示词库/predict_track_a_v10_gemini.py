#!/usr/bin/env python3
"""
MGBIE Track-A 预测脚本 v10 — Gemini 版本
=========================================
与 v9 完全相同的逻辑，但使用 gemini-2.5-flash 模型
目的：获取与 gpt-4.1-mini 风格不同的预测，用于三模型集成投票
"""
import json
import os
import re
...
OUTPUT_PATH = '/home/ubuntu/bisai/数据/A榜/submit_v10_gemini.json'
os.makedirs(os.path.dirname(OUTPUT_PATH), exist_ok=True)

# ===== 超参数 =====
MODEL   = "gemini-2.5-flash"   # 换用 Gemini 模型
WORKERS = 15   # Gemini 并发稍低
SAVE_EVERY = 20
TOP_K   = 5
